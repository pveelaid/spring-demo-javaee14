...
public class OptionalExerciseMain {
    ...
    public static void main(String[] args) {
        ...
        //second argument we implement accept method from Consumer
    ...
    public static Optional<String> personNickIfPresent() {
        return Optional.ofNullable("peeter");
    }
}

//generic interfase consumer  - T will be replaced with string in our case
