...
public class PersonWithAllSourceCode {
    ...
    //Every class has a default constructor - empty argument list, it just assignes default value to all fields.
    ...
    // If you provide equals method, provide hashcode too
    @Override
